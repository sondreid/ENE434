...
fc_loess_interval <- predict(loess_fit, newdata = new_data_fc_loess, interval="prediction")
#new_data_fc_loess["lwr"] = fc_loess_interval[,2]
#new_data_fc_loess["upr"] = fc_loess_interval[,3]


autoplot(new_data_fc_loess %>% as_tsibble(index = monthdate))


new_data_fc_loess   %>% 
   ggplot() +
   geom_line(aes(x = monthdate, y = fc_cost, col = "black")) +
